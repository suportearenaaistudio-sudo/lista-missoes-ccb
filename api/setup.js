...
export default async function handler(req, res) {
  ...
  if (process.env.NODE_ENV === 'development' && token === 'mock-admin-token') {
    ...
    try {
      ...
      console.error('Erro ao verificar token com o Google no setup:', e);
    }
  }
  ...
  try {
    ...
    const seedData = [
      ...
      // IPORÃ REGIONAL - November only
      { date: '2026-11-15', time: '09:00', local: 'Iporã', type: 'Ensaio Regional', parcial: false, section: 'ENSAIOS MENSAIS' },
    ];
